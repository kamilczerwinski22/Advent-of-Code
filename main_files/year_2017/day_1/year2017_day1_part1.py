...
# there are only a few minutes until midnight. "We have a big problem," she says; "there must be almost fifty bugs
...
def solve_captcha() -> int:
    ...
    with open('year2017_day1_challenge_input.txt', 'r') as f:
        sequence = f.read()
        sequence = [int(dig) for dig in sequence + sequence[0]]
