# --- Day 4: The Ideal Stocking Stuffer --- Santa needs help mining some AdventCoins (very similar to bitcoins) to
...
def find_santa_coin_five_zeros() -> int:
    # read input
    ...
    while True:
        ...
        if current_result.startswith('00000'):
            return counter
        counter += 1


if __name__ == '__main__':
    result = find_santa_coin_five_zeros()
    print(result)
